...
class Controller(object):
    def __init__(self, vehicle_mass, fuel_capacity, brake_deadband, decel_limit,
        ...
        #pid parameters were determined experimentally as explained in the DBW walkthrough
        kp = 0.3
        ki = 0.1
        kd = 0.0
        ...
        ts = 0.02  # Sample time
        # The low pass filter is used for the hihg frequency noise in the velocity.
    ...
    def control(self, current_vel, dbw_enabled, linear_vel, angular_vel):
        ...
        # Turn DBW on/off.  If the car is idle and the pid controller is not
        # turned off, the intergral term accumulates error.
